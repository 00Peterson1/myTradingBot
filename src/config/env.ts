...
const envSchema = z.object({
  ...
  MAX_TICK_GAP_SECONDS: z.coerce.number().positive().default(60),
  MAX_SYMBOL_EXPOSURE_FRACTION: z.coerce.number().positive().max(1).default(0.05),
  MAX_STRATEGY_EXPOSURE_FRACTION: z.coerce.number().positive().max(1).default(0.05),
